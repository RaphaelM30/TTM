class Messages:
    """Constant Messages for the application."""

    TASK_ADDED = "Task '{title}' has been added."
    ...
    TASK_NOT_COMPLETED = "Task '{title}' could not be marked as complete."
    TASK_NOT_PRIORITY_CHANGED = "Task '{title}' priority could not be changed."
